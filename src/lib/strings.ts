...
export const t = {
  ...
  spicyContent: "Krydret indhold",
  spicyContentSub: "Voksne spørgsmål og ord — kun for voksne bordet",
  danishContent: "Dansk kultur",
  danishContentSub: "Danske traditioner, steder og vaner",
